...
| File | Contents | Size |
|---|---|---|
| `DOE_merged_mix1_react.csv` | Step-by-step speciation along NaOH titration | ~13 MB |
| `DOE_merged_mix1_i_soln.csv` | Initial solution properties for each sample | ~10 MB |
| `DOE_merged_mix2_react.csv` | Mixed-leachate reaction output | ~13 MB |
| `DOE_merged_mix2_eq_react.csv` | Equilibrium phase analysis | ~13 MB |
