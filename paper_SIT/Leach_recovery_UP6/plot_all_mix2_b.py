...
PH_RANGE = (2.5, 15.2)     # x-axis window for pH in many plots
...
def main():
    ...
    CSV_PATHs = [Path("speciation_results_merged/DOE_merged_mix2_react.csv")] #, Path("DOE_merged_mix1_react.csv")];  # change if needed
    OUT_DIRs  = [Path("figs_mix2_b")]
